...
INSERT INTO BLC_OFFER (OFFER_ID, APPLIES_TO_RULES, OFFER_NAME, START_DATE, END_DATE, OFFER_TYPE, OFFER_DISCOUNT_TYPE, OFFER_VALUE, OFFER_DELIVERY_TYPE, STACKABLE, COMBINABLE_WITH_OTHER_OFFERS, OFFER_PRIORITY, APPLY_OFFER_TO_MARKED_ITEMS, APPLY_TO_SALE_PRICE, USES, MAX_USES,IS_TIERED_OFFER) VALUES (1,NULL, 'Shirts Special',CURRENT_DATE,'2020-01-01 00:00:00','ORDER_ITEM','PERCENT_OFF',20,'AUTOMATIC',1,1,10,0,0,0,0,false);
INSERT INTO BLC_OFFER (OFFER_ID, APPLIES_TO_RULES, OFFER_NAME, START_DATE, END_DATE, OFFER_TYPE, OFFER_DISCOUNT_TYPE, OFFER_VALUE, OFFER_DELIVERY_TYPE, STACKABLE, COMBINABLE_WITH_OTHER_OFFERS, OFFER_PRIORITY, APPLY_OFFER_TO_MARKED_ITEMS, APPLY_TO_SALE_PRICE, USES, MAX_USES,IS_TIERED_OFFER) VALUES (2,NULL, 'sauce Special',CURRENT_DATE,'2020-01-01 00:00:00','ORDER_ITEM','PERCENT_OFF',20,'AUTOMATIC',1,1,10,0,0,0,0,true);

INSERT INTO BLC_OFFER_ITEM_CRITERIA (OFFER_ITEM_CRITERIA_ID, ORDER_ITEM_MATCH_RULE, QUANTITY) VALUES (2, 'MVEL.eval("toUpperCase()",discreteOrderItem.category.name)==MVEL.eval("toUpperCase()","Hot Sauces")', 1);
INSERT INTO BLC_TAR_CRIT_OFFER_XREF (OFFER_ITEM_CRITERIA_ID, OFFER_ID) VALUES (2, 2);

INSERT INTO BLC_OFFER_TIER (OFFER_TIER_ID,AMOUNT,MIN_QUANTITY,OFFER_ID) VALUES (1,10.00000,10,2);
INSERT INTO BLC_OFFER_TIER (OFFER_TIER_ID,AMOUNT,MIN_QUANTITY,OFFER_ID) VALUES (2,30.00000,30,2);
INSERT INTO BLC_OFFER_TIER (OFFER_TIER_ID,AMOUNT,MIN_QUANTITY,OFFER_ID) VALUES (3,20.00000,20,2);
